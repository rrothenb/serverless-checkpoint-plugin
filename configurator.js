...
function configurator(input) {
    ...
    checkpointer.register(sfdcSDK_1.sfdcSDK, function (obj) { return new sfdcSDK_1.sfdcSDK(obj.domain.replace('/elements/api-v2', ''), obj.authorizationHeader); });
    checkpointer.register(generalSDK_1.generalSDK, function (obj) { return new generalSDK_1.generalSDK(obj.domain.replace('/elements/api-v2', ''), obj.authorizationHeader); });
